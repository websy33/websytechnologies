        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {visibleItems < filteredItems.length && (
            <div className="text-center mt-12">
              <button 
                onClick={loadMore}
                className="px-8 py-3.5 bg-white border border-gray-200 text-gray-700 font-medium rounded-full shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500 hover:text-blue-600 flex items-center mx-auto"
              >
          ...
          {/* Call to Action */}
          <div className="text-center mt-16 lg:mt-20 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-10 lg:p-12 shadow-inner">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <button className="px-8 py-3.5 bg-white border border-gray-200 text-gray-700 font-medium rounded-full shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-500 hover:text-blue-600 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
